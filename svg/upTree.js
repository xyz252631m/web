// define([], function () {
    ...
    $.extend(UpTree.prototype, {
        ...
        renderCenter: function (rootItem) {
            ...
            rootItem.g = g;
            var rect = g.rect(200, 40).rx(3).ry(3);
        ...
        renderUp: function (item) {
            ...
            rect_g.rect(item.w + 1, 4).x(-0.5).y(63).fill("#f0a23a");
        ...
        renderDown: function (item) {
            ...
            var g = this.down_node.group(), x = 9;
            item.g = g;
            var rect_g = g.group();
            if (item.animateAdd) {
                g.transform({x: item.px, y: item.py}).animate(this.opt.anTime).transform({
            ...
            rect_g.rect(item.w + 1, 4).x(-0.5).y(63).fill("#65a1ea")
            rect_g.off("click").on("click", function () {
        ...
        renderUpLine: function (item) {
            ...
            if (item.lineUp) {
                ...
                if (item.animateAdd) {
                    sx = item.px + 164 / 2;
                    var path = "M" + sx + "," + (y + 160) + "C" + sx + "," + (y + 160) + "," + sx + "," + (y + 160) + "," + sx + "," + (y + 160); // var d = "M0,180C0,118," + w + ",118," + w + ",56";
                    item.lineUp = g.path(path).stroke({color: "#979797", width: 1}).fill("none");
                    item.lineUp.animate(this.opt.anTime).plot(d);
                } else {
                    item.lineUp = g.path(d).stroke({color: "#979797", width: 1}).fill("none");
                }
            }
        },
        //渲染下方连接线
        renderDownLine: function (item) {
            ...
            if (item.lineDown) {
                ...
                if (item.animateAdd) {
                    sx = item.px + 164 / 2;
                    var path = "M" + sx + "," + y + "C" + sx + "," + y + "," + sx + "," + y + "," + sx + "," + y;
                    item.lineDown = g.path(path).stroke({color: "#979797", width: 1}).fill("none");
                    item.lineDown.animate(this.opt.anTime).plot(d);
                } else {
                    item.lineDown = g.path(d).stroke({color: "#979797", width: 1}).fill("none");
                }
            }
        },
        //鼠标移入事件
        ...
        mouseleave: function (e) {
            ...
            item.lineUp && item.lineUp.stroke("#979797");
            item.arrowUp && item.arrowUp.stroke("#979797").attr("marker-end", "url(#arrow)");
            item.rectDown && item.rectDown.removeClass("hover-down-rect");
            item.lineDown && item.lineDown.stroke("#979797");
            item.arrowDown && item.arrowDown.stroke("#979797").attr("marker-end", "url(#arrow)");
