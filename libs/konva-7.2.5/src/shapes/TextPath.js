define(["require", "exports", "../Util", "../Factory", "../Shape", "./Path", "./Text", "../Validators", "../Global"], function (require, exports, Util_1, Factory_1, Shape_1, Path_1, Text_1, Validators_1, Global_1) {
    "use strict";
    ...
    class TextPath extends Shape_1.Shape {
        constructor(config) {
            ...
            this.on('textChange.konva alignChange.konva letterSpacingChange.konva kerningFuncChange.konva', this._setTextData);
