define(["require", "exports", "./Util", "./Factory", "./Canvas", "./Global", "./DragAndDrop", "./Validators"], function (require, exports, Util_1, Factory_1, Canvas_1, Global_1, DragAndDrop_1, Validators_1) {
    "use strict";
    ...
    const emptyChildren = new Util_1.Collection();
    let idCounter = 1;
    /**
    ...
    class Node {
        ...
        _getTransform() {
            ...
            var x = this.x(), y = this.y(), rotation = Global_1.Konva.getAngle(this.rotation()), scaleX = this.attrs.scaleX ?? 1, scaleY = this.attrs.scaleY ?? 1, skewX = this.attrs.skewX || 0, skewY = this.attrs.skewY || 0, offsetX = this.attrs.offsetX || 0, offsetY = this.attrs.offsetY || 0;
            if (x !== 0 || y !== 0) {
                m.translate(x, y);
            }
            if (rotation !== 0) {
        ...
        static _createNode(obj, container) {
            ...
            const Class = Global_1._NODES_REGISTRY[className];
