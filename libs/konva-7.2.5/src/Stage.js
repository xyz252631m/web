define(["require", "exports", "./Util", "./Factory", "./Container", "./Global", "./Canvas", "./DragAndDrop", "./Global", "./PointerEvents"], function (require, exports, Util_1, Factory_1, Container_1, Global_1, Canvas_1, DragAndDrop_1, Global_2, PointerEvents) {
    "use strict";
    ...
    class Stage extends Container_1.Container {
        ...
        _touchend(evt) {
            ...
            this._changedPointerPositions.forEach((pos) => {
                ...
                if (Global_1.Konva.listenClickTap && shape === this.tapStartShape) {
                    tapTriggered = true;
        ...
        setPointersPositions(evt) {
            ...
            if (evt.touches !== undefined) {
                ...
                this._pointerPositions = [];
                this._changedPointerPositions = [];
                Util_1.Collection.prototype.each.call(evt.touches, (touch) => {
                ...
                Util_1.Collection.prototype.each.call(evt.changedTouches || evt.touches, (touch) => {
